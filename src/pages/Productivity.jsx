  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <div className="text-white max-w-xl space-y-6">
          ...
          <p className="text-lg md:text-xl text-white/90">
            Maximize your productivity with our high-performance PCs, efficient peripherals, and smart accessories built for creators, professionals, and multitaskers.</p>
    ...
    <section className="py-12 px-4 md:px-8 bg-white">
        <div className="mb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-bold">Feature PC Builds for Productivity</h2>
        </div>
