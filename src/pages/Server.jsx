  ...
  return (
    ...
    <section className="w-full bg-white text-center py-6 px-4">
      ...
      <p className="mt-4 text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
        Servers are the backbone of modern computing—enabling secure data management, seamless connectivity, and uninterrupted digital infrastructure.
      </p>
    </section>
    ...
    <section className="py-12 px-4 md:px-8 bg-white">
        <div className="mb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-bold">Feature PC Builds for Server</h2>
        </div>
